...
As you finish your speech, maybe you are walking off the stage or just wrapping up a rehearsal. Either way, keep your arm still for ten seconds. The accelerometer detects a lack of movement, and you will hear a melody, indicating that it is time to check your microbit. You will see the following:

* gestures: first the word "gestures will flash across the Micro:Bit, indicating that the gestures score is about to be revealed.
* gestures value: your gestures score
* pauses: the word "pauses" then flashes across the Micro:Bit
* pauses value: your pauses score
